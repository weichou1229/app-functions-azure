...
public class ReadDeviceToCloudMessages {
  ...
  private static final String eventHubsCompatibleEndpoint = "sb://iothub-ns-essaiiot-2913931-c849f0620b.servicebus.windows.net/";

  // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
  private static final String eventHubsCompatiblePath = "essaiiot";

  // az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
  private static final String iotHubSasKey = "pto2o31P7kuJwEEPNdcUffm4ZxUpfEF9iNPSx5wYXCI=";
            ...
            try {
              ...
              if (receivedEvents != null) {
                for (EventData receivedEvent : receivedEvents) {
                  String jsonStr = new String(receivedEvent.getBytes(), Charset.defaultCharset());
//                  System.out.println(String.format("Telemetry received:\n %s",jsonStr));
                  ReadDeviceToCloudMessages.printJson(jsonStr);
  ...
  private static void printJson(String jsonStr){
     JSONObject obj = new JSONObject(jsonStr);
    System.out.println(obj.toString(4));
    JSONObject json = obj.getJSONObject("body"); // Convert text to object
